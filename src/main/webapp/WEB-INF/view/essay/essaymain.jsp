    ...
    <div class="panel-body">
        ...
        <div id="tabToolBar">
            <div class="btn-group">
                ...
                <button type="button" class="btn btn-default" onclick="essayUpdate()">
                    <span class="glyphicon glyphicon-wrench">修改</span>
                </button>
                <button id="removeButton" type="button" class="btn btn-error">
                    <span class="glyphicon glyphicon-scissors" onclick="deleteAll()">删除</span>
                </button>

            </div>

        </div>
        <table id="essayTable"></table>
    </div>
        ...
        $(function (){
            $("#essayTable").bootstrapTable({
                ...
                columns:[
                    ...
                    /*
                    {field:'user_state',title:'账号状态',width:100,
                        formatter:function(value,row,index){//value 当前字段值  row当前行的数据  index当前行
                            if(value==1){
                                return '<a href="javascript:updateSta('+value+','+row.user_id+')"><font color="green">可用</font></a>';
                            }else if(value==2){
                                return '<a href="javascript:updateSta('+value+','+row.user_id+')"><font color="red">不可用</font></a>';
                            }
                        }},
                   ...
                   /* {field:'caozuo',title:'操作',width:100,
                        formatter:function(value,row,index){//value 当前字段值  row当前行的数据  index当前行
                            var id=row.user_id;
                            //如何再去拼接一个删除按钮
                            return "<input type='button' value='修改' onclick='essayUpdate("+id+")'>";
                        }
