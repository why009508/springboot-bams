...
%>
    <head> 
       ...
       <title>博客</title>
        ...
        <script type="text/javascript" src="front-js/jq.js?v4.1"></script>
        <script type="text/javascript" src="front-js/ss.js?v4.8"></script>
    ...
    <body> 
        <div class="pb-container"> 
            <div class="pb-container-main pb-after-clear"> 
              ...
              return false;"> 
                ...
                <script type="text/javascript" src="front-js/jquery.slideBox.js"></script>
                <script type="text/javascript" src="front-js/ap.js"></script>
                <script>
                     $(document).ready(function() {
        ...
        <script language="javascript" type="text/javascript" src="front-js/15502332.js"></script>
        <noscript>
